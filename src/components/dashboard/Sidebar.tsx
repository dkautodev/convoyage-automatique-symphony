...
import { 
  ...
  ChevronDown, ChevronRight, UserPlus, ContactIcon
} from 'lucide-react';
    ...
    switch (userRole) {
      case 'admin':
        return [
          ...
          { href: '/admin/contacts', icon: <Users className="mr-2 h-4 w-4" />, label: 'Contacts' }
        ];
      case 'client':
        return [
          ...
          { href: '/client/contacts', icon: <Users className="mr-2 h-4 w-4" />, label: 'Mes contacts' }
        ];
      case 'chauffeur':
        return [
