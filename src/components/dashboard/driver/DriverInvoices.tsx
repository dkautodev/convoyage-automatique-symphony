                  ...
                  <div className="flex items-start justify-between flex-wrap gap-2">
                    ...
                    <div className="flex flex-col gap-2 w-full sm:w-auto">
                      ...
                      <div className="flex gap-2">
                        ...
                        {isAdmin && <Button variant={mission.chauffeur_paid ? "secondary" : "default"} size="sm" onClick={() => handleTogglePaidStatus(mission)} disabled={!mission.chauffeur_invoice} className="hidden sm:block mr-1">
