...
export const MissionGeneralInfoSection: React.FC<MissionGeneralInfoSectionProps> = ({
  ...
  return <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="border-t pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              {(mission.contact_pickup_name || mission.contact_pickup_phone) && <div className="text-xs text-gray-500 space-y-1">
            ...
            <div className="space-y-2">
              ...
              {(mission.contact_delivery_name || mission.contact_delivery_phone) && <div className="text-xs text-gray-500 space-y-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm">
                ...
                {(mission.H1_PEC || mission.H2_PEC) && <span className="ml-2 text-gray-600">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm">
                ...
                {(mission.H1_LIV || mission.H2_LIV) && <span className="ml-2 text-gray-600">
        ...
        {(mission.vehicle_make || mission.vehicle_model || mission.vehicle_year || mission.vehicle_registration) && <div className="border-t pt-6">
            <h3 className="font-medium mb-4 flex items-center gap-2">
              <Car className="h-4 w-4" />
              Informations véhicule
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {(mission.vehicle_make || mission.vehicle_model) && <div className="space-y-2">
