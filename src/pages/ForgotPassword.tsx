              ...
              {resetSent ? 
                <div className="text-center py-4">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    ...
                    Le lien vous redirigera vers une page où vous pourrez définir un nouveau mot de passe.
                    Pensez à vérifier dans votre boîte spam si vous ne trouvez pas l'email dans votre boîte de réception.
                  </p>
                </div> : 
                <Form {...form}>
