  ...
  return <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex space-x-2">
          <Button onClick={handleCreateNewMission} className="sm:bg-primary sm:text-primary-foreground sm:hover:bg-primary/90 sm:w-auto w-full bg-neutral-900 text-white hover:bg-neutral-800 h-10 text-xs rounded-sm font-medium">
