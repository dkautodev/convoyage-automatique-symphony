...
const AdminContactsPage: React.FC = () => {
  ...
  const filteredContacts = contacts.filter(contact => {
    ...
    return contact.name_s && contact.name_s.toLowerCase().includes(searchLower) || contact.email && contact.email.toLowerCase().includes(searchLower) || contact.phone && contact.phone.toLowerCase().includes(searchLower);
  });
