...
import ClientMissionsFilters from './ClientMissionsFilters';

type ClientMissionTab = 'all' | MissionStatus;

const ClientMissionsList = () => {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<ClientMissionTab>('all');
  ...
  const EmptyState = () => (
    <div className="text-center py-10 text-neutral-500">
      ...
      <p className="text-sm mt-1">Vos missions apparaîtront ici une fois créées</p>
    </div>
  );
